/*
  Pending pricing — diagnostic SQL for user aacqs2@almoayyedcg.com (literal + variables).

  A) Same enquiry scope as GET /api/pricing/list/pending?userEmail=aacqs2@almoayyedcg.com (step 1–3).
...
BEGIN
    ...
    /* Result 5: base prices for scoped enquiries (CAST Price for numeric columns) */
    SELECT
