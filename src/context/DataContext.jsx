...
export const DataProvider = ({ children }) => {
    ...
    // --- LOCKED LOGIC: REAL-TIME SYNC ---
    // Increments a global counter whenever Enquiry data changes.
    // Dashboard.jsx subscribes to this to trigger immediate re-fetch.
    const triggerDashboardRefresh = () => {
        setDashboardRefreshCounter(prev => prev + 1);
    };
