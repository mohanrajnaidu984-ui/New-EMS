...
const SearchEnquiry = ({ onOpen }) => {
    ...
    // Initialize results with all enquiries in reverse order (latest first)
    useEffect(() => {
        const allEnquiries = Object.values(enquiries).reverse();
    ...
    const handleClear = () => {
        ...
        setFromDate('');
        setToDate('');
        setResults(Object.values(enquiries).reverse());
    };
